...
def noize_generator(X_train, Y_train, img_dir, batch_size, shuffle=True):
    ...
    while True:
        ...
        batch_x = x1 * X_l + x2 * (1 - X_l)
        batch_y = y1 * Y_l + y2 * (1 - Y_l)
...
def train(epochs, seed):
    ...
    gen = noize_generator(X_train_cv, y_train_cv, "input/train", batch_size)
    ...
    model.load_weights(filepath="model/train_180204_1_Dense_2nd_gen_3rd_stage_ts0508.hdf5")
