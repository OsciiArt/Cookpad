...
def train(epochs, seed):
    ...
    gen = train_generator(X_train_cv, y_train_cv, "/home/akiyama/PycharmProjects/Cookpad/input/train_1/", batch_size)
    gen_val = train_generator(X_holdout, Y_holdout, "/home/akiyama/PycharmProjects/Cookpad/input/train_1/", batch_size, shuffle=False)
    gen_val_pred = test_generator(X_holdout, "/home/akiyama/PycharmProjects/Cookpad/input/train_1/", batch_size, shuffle=False)
