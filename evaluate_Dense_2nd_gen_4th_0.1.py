...
def train(epochs, seed):
    ...
    model.load_weights(filepath="model/train_180205_1_Dense_2nd_gen_4th_stage_ts1225.hdf5")
    ...
    submission = pd.DataFrame({'id': X_test, 'predict': np.argmax(pred_test[:,:55], axis=1)})
